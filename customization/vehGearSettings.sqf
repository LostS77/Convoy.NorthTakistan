...
switch (_type) do {
	...
	case "MRAP_MEDICAL": {
		...
		["ACE_fieldDressing", 60] call FUNC(AddItemVehicle);
		["ACE_elasticBandage", 60] call FUNC(AddItemVehicle);
		["ACE_packingBandage", 60] call FUNC(AddItemVehicle);
		["ACE_quikclot", 60] call FUNC(AddItemVehicle);
		["ACE_morphine", 60] call FUNC(AddItemVehicle);
		["ACE_tourniquet", 30] call FUNC(AddItemVehicle);
		["ACE_splint", 30] call FUNC(AddItemVehicle);
