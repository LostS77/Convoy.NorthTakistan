...
case (package + "UAV"): { 
	...
	["B_UavTerminal"] call FUNC(AddItem);
};
...
//Rifleman with M136
//[this, "US_M136"] call FW_fnc_GearScript;
case (package + "M136"): { 
	["rhsusf_spcs_ocp_rifleman","rhsusf_spcs_ocp_rifleman_alt"] call FUNC(AddItemRandom);
	["rhs_weap_M136"] call FUNC(AddItem);
	ADD_GROUP(clothing);
	ADD_GROUP(IFAK);
	ADD_GROUP(bits);
	ADD_GROUP(grenades);
...
//[this, "US_EOD"] call FW_fnc_GearScript;
case (package + "EOD"): { 
	["rhsusf_spcs_ocp_rifleman","rhsusf_spcs_ocp_rifleman_alt"] call FUNC(AddItemRandom);
	ADD_GROUP(clothing);
	ADD_GROUP(IFAK);
...
//Engineer Team Lead
//[this, "US_TL_ENG"] call FW_fnc_GearScript;
case (package + "TL_ENG"): { 
	["rhsusf_spcs_ocp_rifleman","rhsusf_spcs_ocp_rifleman_alt"] call FUNC(AddItemRandom);
	ADD_GROUP(clothing);
	ADD_GROUP(IFAK);
...
//Engineer
//[this, "US_ENG"] call FW_fnc_GearScript;
case (package + "ENG"): { 
	["rhsusf_spcs_ocp_rifleman","rhsusf_spcs_ocp_rifleman_alt"] call FUNC(AddItemRandom);
	ADD_GROUP(clothing);
	ADD_GROUP(IFAK);
...
//Weapons Team Javelin
//[this, "US_JAV"] call FW_fnc_GearScript;
case (package + "JAV"): { 
	["rhsusf_spcs_ocp_rifleman","rhsusf_spcs_ocp_rifleman_alt"] call FUNC(AddItemRandom);
	ADD_GROUP(clothing);
	ADD_GROUP(IFAK);
	...
	ADD_GROUP(grenades);
	ADD_GROUP(M4);
	["UK3CB_BAF_Javelin_CLU"] call FUNC(AddItem);
	["UK3CB_BAF_Javelin_Slung_Tube"] call FUNC(AddItem);
};

//Weapons Team Javelin Assitant
//[this, "US_JAVA"] call FW_fnc_GearScript;
case (package + "JAVA"): { 
	["rhsusf_spcs_ocp_rifleman","rhsusf_spcs_ocp_rifleman_alt"] call FUNC(AddItemRandom);
	ADD_GROUP(clothing);
	ADD_GROUP(IFAK);
