...
arrayObjects[] = {"hc_spawn", "hc_route_1", "hc_route_2", "hc_route_3", "hc_route_4", "hc_patrol_1", "hc_patrol_2", "hc_patrol_3", "hc_patrol_5", "hc_patrol_6", "hc_patrol_7", "hc_patrol_8"};

// Initial spawns are spawned upon init, at the start of the mission.
// eg: ["mainEnemy"]
initialSpawn[] = {"hc_spawn"};
...
initialRandomSpawns[] = {"hc_patrol_1", 1, "hc_patrol_2", 1, "hc_patrol_3", 1, "hc_patrol_5", 1, "hc_patrol_6", 1, "hc_patrol_7", 1, "hc_patrol_8", 1};
